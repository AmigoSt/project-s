...
var createScene = function () {
    ...
    let loadedGUI = advancedTexture.parseFromURLAsync("./gui/guiTexture.json");
    BABYLON.GUI.advancedTexture.renderScale = 1.8;
    let btn_devPanel = advancedTexture.getControlByName("btn_dev");
